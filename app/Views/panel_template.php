...
<head>
    ...
    <script src="<?php echo base_url('panel/js/sb-admin-2.min.js'); ?> "></script>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">AutoControl</div>
            </a>
    ...
    <script src="<?php echo base_url('panel/js/demo/datatables-demo.js'); ?>"></script>
    <!-- Page level custom scripts -->
