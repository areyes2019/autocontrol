...
<head>
    ...
    <title>AutoControl - Entrar</title>
    ...
    <link href="<?php echo base_url('panel/css/sb-admin-2.min.css');?>" rel="stylesheet">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-8 d-none d-lg-block bg-login-image">
                                <img src="<?php echo base_url('img/taller.jpg'); ?>" alt="Taller Mecánico" width="660">
                            </div>
                            <div class="col-lg-4">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="authenticate" method="post">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                ...
                                                placeholder="Escribe tu direccion de correo..."  name="username">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Escribe tu contraseña" name="password">
                                        </div>
