...
<h1 class="h3 mb-2 text-gray-800 mt-4">Empleados</h1>
                ...
                <tbody>
                    <tr v-for = "empleado in empleados">
                        ...
                        <td class="align-items-center">
                            <button class="btn btn-primary btn-circle btn-sm mr-2" @click="mostrar_acutualizar(empleado.empleado_id)">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="btn btn-danger btn-circle btn-sm mr-2" @click="advertencia(empleado.empleado_id)">
        ...
        <div class="modal-content rounded-0">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <select name="" id="" class="form-control" v-model="cargo">
                    <option value="" disabled>Escoga una opción</option>
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" v-model="salario" placeholder="Ingrese el sueldo">
            </div>
        </form>
          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-body">
                ...
                <div class="d-flex justify-content-center">
                    <button class="btn btn-primary rounded-0" @click="eliminar(empleado)">Continuar</button>
                </div>
          </div>
          <div class="modal-footer">
      ...
      <div class="modal-dialog">
        <div class="modal-content rounded-0">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
                <label for="nombre">Nombre:</label>
                <input type="text" class="form-control d-none" id="nombre" v-model="empleado_id">
